...
import 'package:task_assignments/core/networking/api_provider.dart';
import 'package:task_assignments/model/repositries.dart';
import 'package:task_assignments/model/user.dart';
import 'package:task_assignments/utils/api.dart';

class GithubService {
  final _apiProvider = ApiProvider();

  Future<List<Repositries>> getUserRepositoriesList(String? username) async {
    final url = '${Api.api}/users/$username/repos';
    print('objecttttttttt$url');
