...
import 'package:task_assignments/screen/profile_screen/components/profile_mobile_view.dart';
import 'package:task_assignments/screen/profile_screen/components/profile_webview.dart';
...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  void initState() {
    Future.delayed(Duration.zero, () {
      ...
      Provider.of<GithubBloc>(context, listen: false)
          .getUserRepositoriesList(widget.username);
